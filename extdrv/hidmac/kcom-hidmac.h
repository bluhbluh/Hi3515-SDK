...
#define UUID_HI_DMAC_V_1_0_0_0 "hi-dmac-1.0.0.0"
	...
	#define DMAC_SIO1_RX_REQ  	                 2
	#define DMAC_SIO1_TX_REQ  	                 3
	#define DMAC_SIO2_RX_REQ                     4
	#define DMAC_SIO2_TX_REQ                     5
	#define DMAC_SSP_RX_REQ  	                 6
	#define DMAC_SSP_TX_REQ  	                 7
	#define DMAC_MMC_RX_REQ  	                 8
	#define DMAC_MMC_TX_REQ  	                 9
	#define DMAC_UART0_RX_REQ  	                 10
	#define DMAC_UART0_TX_REQ  	                 11
	#define DMAC_UART1_RX_REQ  	                 12
	#define DMAC_UART1_TX_REQ  	                 13
	#define DMAC_UART2_RX_REQ                    14
	#define DMAC_UART2_TX_REQ                    15 
