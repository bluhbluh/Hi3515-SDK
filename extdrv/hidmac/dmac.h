...
#define OSDRV_MODULE_VERSION_STRING "HIDMAC-MDC030003 @Hi3511v110_OSDrv_1_0_0_7 2009-03-18 20:52:37"
...
#else	/* ´ÓARM*/
    #define DMAC_INTSTATUS 	                        IO_ADDRESS(DMAC_BASE_REG + 0X40)
	#define DMAC_INTTCSTATUS                        IO_ADDRESS(DMAC_BASE_REG + 0X44)
	#define DMAC_INTERRORSTATUS                     IO_ADDRESS(DMAC_BASE_REG + 0X48)
#endif
...
#else
    #define DMAC_CxCONFIG_SIO_P2M                   0x00181000  
    #define DMAC_CxCONFIG_SIO_M2P                   0x00180800
#endif
	...
	#define SIO1_BASE_REG                            0x10050000
    ...
    #define SIO2_BASE_REG                            0x10060000
	...
	#define SIO1_RX_CONFIG                           (DMAC_CxCONFIG_SIO_P2M|(0x02<<1))	
	
	#define SIO1_TX_CONTROL                          0x85489000 
	#define SIO1_TX_CONFIG                           (DMAC_CxCONFIG_SIO_M2P|(0x03<<6))                     
	
    #define SIO2_RX_CONTROL                          0x8a489000    
    #define SIO2_RX_CONFIG                           (DMAC_CxCONFIG_SIO_P2M|(0x04<<1))  
	
    #define SIO2_TX_CONTROL                          0x85489000 
    #define SIO2_TX_CONFIG                           (DMAC_CxCONFIG_SIO_M2P|(0x05<<6)) 
