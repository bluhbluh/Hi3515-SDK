...
HI_S32 SAMPLE_MISC_ViDump(VI_DEV ViDev, VI_CHN ViChn, HI_U32 u32Cnt)
{	
    int i, j;
    ...
    printf("usage: ./vi_dump [videv] [vichn] [frmcnt]. sample: ./vi_dump 0 0 5\n\n");
    ...
    sprintf(szYuvName, "./vi(%d,%d)_%d_%d_%s_%d.yuv",ViDev, ViChn,
...
{	 
    ...
    SAMPLE_MISC_ViDump(ViDev, ViChn, u32FrmCnt);
