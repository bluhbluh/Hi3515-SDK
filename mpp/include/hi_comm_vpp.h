...
typedef struct hiVIDEO_PREPROC_CONF_S
{
    ...
    */
	...
	DSU_HSCALE_FILTER_E enHFilter;   /*horizontal scale filter*/
	DSU_VSCALE_FILTER_E enVFilterL;   /*vertical scale filter for luminance*/
	DSU_VSCALE_FILTER_E enVFilterC;   /*vertical scale filter for chroma*/
